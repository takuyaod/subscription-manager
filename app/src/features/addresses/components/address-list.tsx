        ...
        <div className="border border-[#222729] bg-[#111416] overflow-hidden rounded-[10px]">
          {filtered.map((address, i) => (
            ...
            >
              ...
              <div
                className="flex h-9 w-9 shrink-0 items-center justify-center font-mono text-base font-bold rounded-[8px]"
                style={{
                  border: `1px solid ${address.isActive ? "#3dd68c44" : "#22272944"}`,
                  background: address.isActive ? "#3dd68c0e" : "transparent",
                  color: address.isActive ? "#3dd68c" : "#3d4549",
                }}
              >
                ⌂
              </div>
              <Link href={`/addresses/${address.id}`} className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-0.5">
                  ...
                  <span className={`inline-flex items-center border px-1.5 py-px font-mono text-[10px] font-bold uppercase tracking-[0.06em] shrink-0 rounded-[4px] ${
                    address.isActive
