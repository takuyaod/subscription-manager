  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 max-w-md">
      <div className="space-y-1">
        <label className="font-mono text-[10px] font-bold uppercase tracking-widest text-[#3d4549]">ニックネーム <RequiredMark /></label>
        <Input name="nickname" defaultValue={paymentMethod?.nickname} required />
      </div>

      <div className="space-y-1">
        <label className="font-mono text-[10px] font-bold uppercase tracking-widest text-[#3d4549]">種別</label>
        <Select
          name="type"
          value={type}
      ...
      {hasExpiry && (
        <div className="space-y-1">
          <label className="font-mono text-[10px] font-bold uppercase tracking-widest text-[#3d4549]">有効期限</label>
      ...
      {isLinked && (
        <div className="space-y-1">
          <label className="font-mono text-[10px] font-bold uppercase tracking-widest text-[#3d4549]">親カード</label>
      ...
      {hasBank && (
        <div className="space-y-1">
          <label className="font-mono text-[10px] font-bold uppercase tracking-widest text-[#3d4549]">引き落とし口座</label>
